...
class Database():
    ...
    def addEntry(self, username, password, course, studentID):
        self.cursor.execute('''INSERT INTO profile VALUES (NULL, "{}", "{}", "{}", "{}")'''.format(username.lower(), password, course, studentID))
        self.conn.commit()
    ...
    def getUserData(self, username):
        return self.cursor.execute('''SELECT USERNAME, COURSE, STUDENT_ID FROM profile WHERE USERNAME="{}"'''.format(username.lower()))